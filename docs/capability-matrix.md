...
| Auto-hidden fullscreen titlebar | tested | implemented | implemented | implemented | Opt-in theme-colored surface overlay reveals at the top edge in borderless/frameless fullscreen, consumes chrome input, and exposes minimize/restore/close. Windows automated tests pass; macOS/X11/Wayland visual compositor verification remains. |
